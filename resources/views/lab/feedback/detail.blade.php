...
<nav class="flex" aria-label="Breadcrumb">
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    <li class="inline-flex items-center">
      <a href="{{ route('lab.feedback.index', auth()->id()) }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-green-600 dark:text-gray-400 dark:hover:text-white">
    ...
    <div class="flex flex-col justify-between space-y-2 h-full">
        ...
        <div class="flex w-full md:flex justify-between space-x-3 h-full">
            ...
            <div class="flex flex-col md:flex space-y-2 h-max grow min-h-screen" id="feedback" role="tabpanel" aria-labelledby="feedback-tab">
                ...
                <!-- chat box -->
                <form action="{{ route('lab.reply.l_send', $feedback->id) }}" method="POST" class="block">
                    @csrf
                        <div class="flex">
                        @if ($errors->any())
                        ...
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 shadow-lg">
                            ...
                            <input type="hidden" name="lab_id" value="{{ $feedback->class->lab->id }}">
