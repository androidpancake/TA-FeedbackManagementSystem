...
<h1 class="font-bold text-2xl">Feedback</h1>
    <div class="lg:flex justify-between space-y-2 mt-4 items-center">
        <div class="flex overflow-x-auto lg:flex-row space-x-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
        ...
        <!-- select < sm screen -->
        <!-- <form action="{{ route('lab.feedback.index', auth()->id()) }}" method="GET">
            <select name="status" onchange="this.form.submit()" class="w-full lg:hidden bg-white border border-gray-300 hover:bg-gray-200 focus:border-green-500 focus:ring-green-300 rounded-lg text-sm px-4 py-2.5 text-center inline-flex justify-start items-center">
                ...
                <option value="tunggu" selected>Menunggu respon</option>
                <option value="baca">Diproses</option>
        ...
        <div class="flex space-x-2 align-middle">
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownCategory">
                    <li>
                        <a href="{{ route('lab.feedback.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Semua</a>
                    </li>
                    @foreach($category as $data)
                    <li>
                        <a href="{{ route('lab.feedback.category', $data->name) }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ $data->name }}</a>
                    </li>
                    @endforeach
                </ul>
            </div>
            <form action="{{ route('lab.feedback.index', auth()->id()) }}" method="GET" class="w-full">
                ...
                <div class="sm:bg-white py-6 space-y-3">
                    ...
                    <div class="flex flex-col">
                        <div class="flex space-x-2">
                            ...
                            <span class="bg-green-100 text-green-800 text-xs font-semibold inline-flex items-center px-2.5 py-0.5 rounded-md mr-2 dark:bg-gray-700 dark:text-gray-400 border border-green-300">
                                <img src="{{ $data->category->label }}" class="w-4 h-4 mr-1" alt="">
                                {{ $data->category->name }}
                            </span>
                        </div>
                        <p class="text-sm mt-2 text-gray-500">
