...
<h1 class="font-bold text-2xl">Quick Survey</h1>
    <div class="flex flex-col space-y-2 space-x-0 lg:flex-row justify-between mt-4 items-center">
        ...
        <div class="flex flex-col w-full space-y-2 lg:hidden">
            ...
            <form action="{{ route('lab.survey.search') }}" method="GET" id="search-form">
        ...
        <div class="flex lg:w-auto">
            <div class="flex">
                <a href="{{ route('lab.survey.create') }}" class="inline-flex space-x-2 p-4 sm:px-3 py-2.5 bg-green-600 text-white rounded">
                    <p>+</p>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody id="survey-container">
                    @include('lab.survey.filter.survey')
                </tbody>
            </table>
...
<script>
    function getAllSurveys() {
        $.ajax({
            url: '/lab/getAllSurvey/', // Ganti URL dengan endpoint yang tepat untuk mendapatkan semua survei
            method: 'GET',
...
<script>
    ...
    document.getElementById('search-button').addEventListener('click', function() {
        ...
        var url = '{{ route("lab.survey.search") }}?start_date=' + startDate + '&end_date=' + endDate;
