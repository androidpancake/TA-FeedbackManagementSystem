    ...
    <div class="flex justify-between py-2 mt-2 items-center">
        <div class="flex space-x-2 overflow-x-auto" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <button id="read-tab" role="tab" data-tabs-target="#read" aria-selected="false" aria-controls="read" type="button" class="py-2 px-2 rounded-lg font-semibold text-gray-700 text-sm inline-flex items-center space-x-1">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1 text-gray-500" fill="currentColor" viewBox="0 0 256 256"><path d="M228.44,89.34l-96-64a8,8,0,0,0-8.88,0l-96,64A8,8,0,0,0,24,96V200a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V96A8,8,0,0,0,228.44,89.34ZM96.72,152,40,192V111.53Zm16.37,8h29.82l56.63,40H56.46Zm46.19-8L216,111.53V192ZM128,41.61l81.91,54.61-67,47.78H113.11l-67-47.78Z"></path></svg>                
                <p>Dibaca</p>
                <p>{{ count($read) }}</p>
            </button>
        ...
        <div class="flex w-auto space-x-2">
            <!-- periode -->
            <!-- <button id="dropdownPeriod" data-dropdown-toggle="dropdown" class="bg-white border hover:bg-gray-200 focus:border-green-500 focus:ring-green-500 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex justify-between items-center grow" type="button">
                Periode
            ...
            <!-- <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownPeriod">
                    <li>
                        <a href="{{ route('lecturer.feedback.index') }}" class="block px-4 py-2 hover:bg-gray-100">Semua</a>
                    </li>
                    @foreach($period as $data)
                    <li>
                        <a href="#" class="block space-x-2 px-4 py-2 hover:bg-gray-100">
            ...
            <!-- category -->
            <button id="dropdownCategory" data-dropdown-toggle="dropdownCat" class="bg-white border hover:bg-gray-200 focus:border-green-500 focus:ring-green-500 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex justify-between items-center grow" type="button">
                Kategori
                <svg class="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                </svg>
            ...
            <!-- Dropdown menu -->
            <div id="dropdownCat" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow">
