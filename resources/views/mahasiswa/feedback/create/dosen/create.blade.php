...
<div class="grid justify-center pb-4">
    ...
    @if(session('error'))
    <div class="bg-red-100 text-red-600 my-2 p-2 rounded">
        {{ session('error') }}
    </div>
    @endif
    <div class="mt-10">
        <form action="{{ route('mahasiswa.feedback.store') }}" method="POST" class="space-y-8" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" name="subject" id="large-input" class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-md focus:ring-green-500 focus:border-green-500" placeholder="Masukkan subjek">                            
                @error('subject')
                <div class="pt-2 text-sm text-red-600">
                    {{ $message }}
                </div>
            ...
            <div>           
                ...
                <textarea id="message" name="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-green-500 focus:border-green-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500" placeholder="Write your thoughts here..."></textarea>
            ...
            <div>
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="multiple_files">Unggah file pendukung (opsional)</label>
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <ul class="max-w-lg space-y-1 text-gray-500 list-disc list-inside">
                            ...
                            <li>
                                Pastikan informasi yang anda berikan kepada dosen adalah informasi yang benar
                            </li>
                            <li>
