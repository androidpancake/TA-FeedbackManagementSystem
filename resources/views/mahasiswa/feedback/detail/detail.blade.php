...
<div class="sm:flex justify-between space-x-3 overflow-y-hidden">
    <!-- replies -->
    <div class="hidden h-screen sm:h-screen flex flex-col justify-between w-full" id="feedback" role="tabpanel" aria-labelledby="feedback-tab">
        <div class="mt-4 space-y-2 overflow-y-auto">
            ...
            <div class="flex justify-end">
                <div class="w-64 md:w-1/2 bg-green-500 rounded-lg border">
                    <div class="p-4">
                        <div class="flex space-x-2 items-center border-b pb-3">
                            <img src="../../../icons/Teacher.png" alt="" class="rounded-full">
                            @if($feedback->anonymous == 0)
        ...
        <form action="{{ route('mahasiswa.reply.m_send', $feedback->id) }}" method="POST" class="block">
            @csrf
            <div class="">
                @if ($errors->any())
