...
<h1 class="font-bold text-2xl">Komplain</h1>
                        ...
                        <div class="inline-flex space-x-2">
                            ...
                            <div id="dropdownID4" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                                <ul aria-labelledby="dropdownDelete" class="py-2 text-sm text-gray-700">
                                    <li>
                                        <button data-modal-target="modalID2" data-modal-toggle="modalID2" class="w-full px-4 py-2 text-base hover:bg-gray-100">Hapus komplain</button>
                                    </li>
                                </ul>
                            </div>
                            <!-- Delete modal -->
    ...
    <a href="{{ route('mahasiswa.complaint.create') }}" class="fixed bottom-4 right-3 m-6 w-auto p-3 bg-green-500 hover:bg-green-800 py-2 rounded shadow-lg">
        <p class="text-base text-white flex">Kirim complaint</p>
    </a>    
@endsection