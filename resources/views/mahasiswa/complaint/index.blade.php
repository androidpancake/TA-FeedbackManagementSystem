    ...
    <div class="px-8">
        ...
        <div class="flex justify-between py-2 mt-2 items-center">
            <div class="hidden lg:flex space-x-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <button id="all-tab" role="tab" data-tabs-target="#all" aria-selected="true" aria-controls="all" type="button" class="py-2 px-2 bg-gray-100 rounded-lg font-semibold text-gray-700 text-sm inline-flex items-center space-x-1">
                    <p>Semua</p>
                    <p>{{ count($complaint) }}</p>
                </button>
