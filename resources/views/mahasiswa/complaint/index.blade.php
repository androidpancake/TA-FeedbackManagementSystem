...
<div class="px-8">
    ...
    <div class="flex justify-between py-2 mt-2 items-center">
        ...
        <div class="flex w-96 space-x-2">
            <button id="dropdownCategory" data-dropdown-toggle="dropdown" class="grow bg-white border hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center" type="button">
                Kategori
