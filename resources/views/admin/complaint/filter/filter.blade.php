...
@section('content')
<div class="px-8">
    <h1 class="font-semibold text-2xl">Komplain</h1>
        <div class="lg:flex justify-between space-y-2 mt-4 items-start">
            <div class="hidden lg:flex space-x-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                <button id="wait-tab" role="tab" data-tabs-target="#wait" aria-selected="false" aria-controls="wait" type="button" class="py-2 px-3 bg-gray-200 rounded-lg font-semibold text-gray-700 text-sm inline-flex items-center space-x-1">
            ...
            <div class="flex sm:w-64 space-x-2">
                <button id="dropdownCategory" data-dropdown-toggle="dropdown" class="grow bg-white border hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center" type="button">{{ $data->name }}
            ...
            <div id="wait" role="tabpanel" aria-labelledby="wait-tab">
                <div class="divide-y divide-gray-400 mt-6">
                    ...
                    <a href="{{ route('admin.complaint.detail', $data->id) }}" class="block">
                        <div class="bg-white py-6 space-y-3">
                            ...
                            <div class="flex flex-col">
                                <div class="flex space-x-2">
                                    ...
                                    <span class="{{ $data->category->bg }} text-xs font-semibold inline-flex items-center px-3.5 py-0.5 rounded-md mr-2">
