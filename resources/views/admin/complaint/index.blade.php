...
<h1 class="font-bold text-2xl">Komplain</h1>
    <div class="lg:flex justify-between space-y-2 mt-4 items-start">
        <div class="hidden lg:flex space-x-2" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            ...
            <button id="wait-tab" role="tab" data-tabs-target="#wait" aria-selected="true" aria-controls="wait" type="button" class="py-2 px-2 rounded-lg font-bold text-gray-700 text-sm inline-flex items-center space-x-1">
