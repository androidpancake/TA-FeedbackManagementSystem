...
@section('content')
<h1 class="font-bold text-2xl">Keluhan</h1>
    <div class="flex justify-between space-y-2 mt-4 items-start">
        ...
        <div class="flex sm:w-64 space-x-2">
            <button id="dropdownCategory" data-dropdown-toggle="dropdown" class="grow bg-white border hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center" type="button">Kategori
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownCategory">
                    ...
                    <li>
                        <a href="{{ route('admin.complaint.category', $data->name) }}" class="inline-flex w-full space-x-3 px-4 py-2 hover:bg-gray-100">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex items-center space-x-2 mt-3">
                                ...
                                @if(count($data->complaint_reply) != 0)
                                    <p class="text-sm text-blue-500">{{ count($data->complaint_reply) }}</p>
                                @else
