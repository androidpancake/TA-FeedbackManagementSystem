...
<div class="bg-gray-100 px-2 w-full space-y-3">
    <!-- layout -->
    <div class="flex flex-col justify-between space-y-2 h-screen">
        <!-- tabs < sm -->
            ...
            <div class="flex flex-col md:flex space-y-2 h-max grow min-h-screen" id="complaint" role="tabpanel" aria-labelledby="complaint-tab">
                ...
                <div class="flex flex-col h-72 rounded-lg space-y-3 overflow-y-auto grow max-h-fit md:h-96">
                    <div class="bg-white rounded-lg border-2 border-gray-200">
                        <div class="flex flex-row justify-between border-b p-4 items-center">
                            ...
                            <div>               
                                <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-green-500 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center" type="button">Tugaskan ke.. 
                                ...
                                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                        ...
                                        <li class="block">
                                            <form action="{{ route('admin.complaint.assign', ['id' => $complaint->id, 'assigned_to' => $data->id]) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="block w-full text-start px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                                    {{ $data->name }}
                                                    <div>
                                                        <span class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full">{{ $data->role }}</span>
                                                    </div>
                                                </button>
                                            </form>
                                        </li>
                ...
                <div class="flex flex-col bg-white p-4 rounded-md w-72">
                    ...
                    <div class="flex flex-col space-y-2 w-full">
                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="text-sm font-medium inline-flex items-center space-x-2">
                                <p class="text-sm font-medium text-right">{{ $complaint->user->fclass->lecturer->name }}</p>
                            </div>
                        </div>
                        <div class="flex justify-between">
                            <p class="text-sm text-gray-500">Kelas Asal</p>
                            <div class="text-sm font-medium inline-flex items-center space-x-2">
                                <p class="text-sm font-medium text-right">{{ $complaint->user->fclass->name }}</p>
                            </div>
                        </div>
                        <div class="flex justify-between items-center">
                            <p class="text-sm text-gray-500">Kategori</p>
