...
<div class="">
    <div class="px-8">
        <h1 class="font-semibold text-gray-700 text-2xl">Keluhan Penugasan</h1>
        <div class="flex justify-between py-2 mt-2 items-center">
            ...
            <div class="flex space-x-2 overflow-x-auto" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                ...
                <button id="read-tab" role="tab" data-tabs-target="#read" aria-selected="false" aria-controls="read" type="button" class="hover:bg-gray-100 py-2 px-3 rounded-lg font-semibold text-gray-700 text-sm inline-flex items-center space-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-1 text-gray-500" fill="currentColor" viewBox="0 0 256 256">
            ...
            <div class="flex w-64 space-x-2">
                ...
                <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownCategory">
                        <li>
                            <a href="{{ route('admin.complaint.assigned', auth()->id()) }}" class="block px-4 py-2 hover:bg-gray-100">Semua</a>
                        </li>
                        @foreach($category as $data)
                        <li>
                            <a href="{{ route('admin.complaint.categoryAssigned', $data->name) }}" class="block space-x-2 px-4 py-2 hover:bg-gray-100">
                ...
                <form action="{{ route('admin.complaint.assigned', auth()->id()) }}" method="GET" class="w-full">
            ...
            <div class="divide-y divide-gray-200">
                ...
                <a href="{{ route('admin.complaint.detail', $data->id) }}" class="block">
                    <div class="sm:bg-white py-6 px-8 hover:bg-gray-50">
                        <div class="flex md:flex-row items-center justify-between space-x-2 mb-2">
