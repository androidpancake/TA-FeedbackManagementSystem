    ...
    <h1>{{ $items->name }}</h1>
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">ID Kelas</th>
                            <th scope="col" class="px-4 py-3">Kelas</th>
                            <th scope="col" class="px-4 py-3">Dosen</th>
                            <th scope="col" class="px-4 py-3">Jumlah mahasiswa</th>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="dropdown{{ $data->id }}" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="dropdownID{{ $data->id }}">
                                        ...
                                        <li>
                                            <a href="{{ route('admin.course.class', $data->id) }}" class="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
