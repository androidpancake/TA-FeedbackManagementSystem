            ...
            <div class="h-full flex flex-col justify-between px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
                <div class="mt-2">
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('mahasiswa.complaint.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 256 256">
                        ...
                        <!-- <li>
                        <a href="{{ route('mahasiswa.survey.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            ...
                            <span class="ml-3 font-semibold text-gray-700">Quick Survey (temp)</span>
                        </a>
                    </li> -->
                        <li>
                            <a href="{{ route('mahasiswa.notification') }}" class="flex items-center justify-between p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <span class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-xs font-medium text-blue-800 bg-blue-100 rounded-full">{{ Auth::user()->unreadNotifications->count() }}</span>
                            </a>
                        </li>
                    </ul>
                </div>
