                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <a href="#" class="hidden md:flex mr-24">
                            <img src="{{ asset('storage/image/logo-si.png') }}" class="w-8 sm:w-auto h-8 mr-3" alt="FRI Logo" />
                        </a>
                    </div>
                    <div>
                        @yield('breadcrumb')
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-10 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full flex flex-col justify-between px-3 py-4 overflow-y-auto bg-white dark:bg-gray-800">
            <div class="mt-2">
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('lecturer.dashboard') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <a href="{{ route('lecturer.feedback.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <a href="{{ route('lecturer.survey.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <li>
                        <a href="{{ route('lecturer.course.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-500" fill="currentColor" viewBox="0 0 256 256"><path d="M216,40H40A16,16,0,0,0,24,56V200a16,16,0,0,0,16,16H53.39a8,8,0,0,0,7.23-4.57,48,48,0,0,1,86.76,0,8,8,0,0,0,7.23,4.57H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40ZM80,144a24,24,0,1,1,24,24A24,24,0,0,1,80,144Zm136,56H159.43a64.39,64.39,0,0,0-28.83-26.16,40,40,0,1,0-53.2,0A64.39,64.39,0,0,0,48.57,200H40V56H216ZM56,96V80a8,8,0,0,1,8-8H192a8,8,0,0,1,8,8v96a8,8,0,0,1-8,8H176a8,8,0,0,1,0-16h8V88H72v8a8,8,0,0,1-16,0Z"></path></svg>
                            <span class="ml-3 font-semibold text-gray-700">Mata Kuliah</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('lecturer.notification') }}" class="flex items-center justify-between p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <div>
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('lecturer.profile', Auth()->id()) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
