            ...
            <div class="h-full flex flex-col justify-between px-3 py-4 overflow-y-auto bg-white border-r dark:bg-gray-800">
                <div class="mt-2">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li>
                            <a href="{{ route('lecturer.feedback.index', Auth()->id()) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <li>
                            <a href="{{ route('lecturer.survey.index', Auth()->id()) }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
